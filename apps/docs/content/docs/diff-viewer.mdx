...
- **Push/Pull** - Sync with remote. When a workspace has a linked open PR, push targets the PR's head branch and the sidebar shows **Push to PR** with the destination branch in the tooltip.
