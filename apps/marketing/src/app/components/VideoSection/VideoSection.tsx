	...
	return (
		<section className="relative py-12 px-8 lg:px-[30px]">
			<div className="max-w-7xl mx-auto">
				...
				<div>
					<div
						className="group relative w-full aspect-video overflow-hidden bg-[#3D2817] border-4"
						...
						{isPlaying ? (
							...
							>
								...
								<div className="absolute inset-0 flex items-center justify-center">
									<div
										className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center bg-[#5DB65D] border-3"
										style={{ borderColor: "#7dce7d #3a6b20 #3a6b20 #7dce7d" }}
									>
